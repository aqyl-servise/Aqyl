    ...
    <div className="aqyl-b2c" style={{ minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "36px 24px" }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 14, lineHeight: 1.6, margin: "0 0 18px" }}>
          5 990 ₸ за месяц доступа. Оплата разовая: деньги списываются один раз за выбранный период.
          Автоматических списаний нет — повторно ничего не спишется.
          Мы напомним об окончании периода письмом за 3 дня.
        </p>
          {PLANS.map((plan) => {
