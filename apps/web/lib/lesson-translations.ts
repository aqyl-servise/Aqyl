...
const ru: Dict = {
  ...
  pipeTopic: "Тема", pipePlan: "КМЖ-план", pipeWarmup: "Разминка", pipeExplain: "Объяснение", pipeTask: "Задание", pipeQuiz: "Квиз", pipeReflect: "Рефлексия",
...
const kz: Dict = {
  ...
  pipeTopic: "Тақырып", pipePlan: "ҚМЖ-жоспар", pipeWarmup: "Қыздыру", pipeExplain: "Түсіндіру", pipeTask: "Тапсырма", pipeQuiz: "Квиз", pipeReflect: "Рефлексия",
