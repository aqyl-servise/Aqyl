...
const ru: Dict = {
  ...
  pkgWho_p3: "Распробовать после бесплатных уроков",
  pkgWho_p10: "Закрыть тяжёлые уроки недели",
  pkgWho_p30: "1–2 готовых урока в учебный день",
  pkgWho_p64: "Полная норма — каждый урок под ключ",
  ...
  balTopupHint: "Докупите {n} уроков за {p} ₸ — весь баланс продлится на 3 месяца",
...
const kz: Dict = {
  ...
  pkgWho_p3: "Тегін сабақтардан кейін байқап көру",
  pkgWho_p10: "Аптаның қиын сабақтарын жабу",
  pkgWho_p30: "Оқу күніне 1–2 дайын сабақ",
  pkgWho_p64: "Толық норма — әр сабақ дайын күйінде",
  ...
  balTopupHint: "{n} сабақты {p} ₸-ге қосыңыз — бүкіл баланс 3 айға ұзарады",
...
const en: Dict = {
  ...
  pkgWho_p3: "A taste after the free lessons",
  pkgWho_p10: "Cover the hardest lessons of the week",
  pkgWho_p30: "1–2 ready lessons per school day",
  pkgWho_p64: "Full workload — every lesson covered",
  ...
  balTopupHint: "Top up {n} lessons for {p} ₸ — your whole balance extends by 3 months",
