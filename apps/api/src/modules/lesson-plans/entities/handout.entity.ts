...
export class Handout {
  ...
  // Блок оценивания не прошёл валидацию баллов даже после двух перегенераций,
  // и шкала/баллы построены детерминированным запасным алгоритмом (ТЗ 1.5.2).
  // По флагу отбираются проблемные листы для ручного разбора.
  @Column({ type: 'boolean', default: false })
